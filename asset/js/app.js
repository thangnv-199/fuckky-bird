const app = {
    ...
    init: function() {
        ...
        this.background = new Background(backgrounds[backgroundIndex]);
        this.base = new Base();
        this.bird = new Bird(birds[birdIndex]);
    ...
    listenerEvent: function() {
        ...
        backgrounds.forEach(bg => {
            bg.addEventListener('load', () => {
                ctx.drawImage(backgrounds[this.getStorageData('background')], 0, 0, GAME_WIDTH, GAME_HEIGHT);
            })
        })
    ...
    setGameInfo: function() {
        ...
        bgSelect[this.getStorageData('background')].classList.add('selected');
